...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='denominacion',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='usos', to='divisas.denominacion', verbose_name='Denominación'),
        ),
        migrations.AddField(
            model_name='desglosedenominacion',
            name='transaccion',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='desglose_denominaciones', to='transacciones.transaccion', verbose_name='Transacción'),
        ),
        migrations.AddIndex(
            model_name='divisa',
        ...
        migrations.AddField(
            ...
            name='divisa',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='denominaciones', to='divisas.divisa', verbose_name='Divisa'),
        ),
        migrations.AddField(
            model_name='cotizacionsegmento',
            name='divisa',
