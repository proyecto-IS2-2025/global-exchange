...
class ClienteModelTest(TestCase):
    ...
    def test_segmento_predeterminado(self):
        ...
        self.assertEqual(cliente_sin_segmento.segmento, "General")
    ...
    def test_cedula_debe_ser_unica(self):
        ...
        excepcion_capturada = cm.exception
        self.assertIn('restricción de unicidad', str(excepcion_capturada))
    ...
    def test_nombre_completo_no_puede_ser_vacio(self):
        ...
        """
        cliente_invalido = Cliente(cedula="111111111", nombre_completo="")
